...
const SIGNUP_LINK = process.env.SIGNUP_LINK || 'https://nexus-ai-pro.com';
...
const CAPTIONS_IMAGE = [
  "🎨 AI-Generated Art\n\n✨ 100% AI Created with Nexus AI Pro\n🖼️ Model: {model}\n\n👉 Create your own: {link}\n\n#AIArt #AIGenerated #NexusAIPro #DigitalArt #Trending",
  "🔥 AI Masterpiece\n\n💫 Generated by Nexus AI Pro\n🎭 Model: {model}\n\n🚀 Try free — 35 credits on signup: {link}\n\n#AIArt #NexusAI #AIImage #CreativeAI #ArtificialIntelligence",
  "✨ AI Creation\n\n🤖 Powered by 63+ AI Models\n📸 Model: {model}\n\n🔗 Start creating free: {link}\n\n#AIGenerated #NexusAIPro #AIArt #DigitalCreation #Trending",
  "💎 Premium AI Art\n\n⚡ Created with Nexus AI Pro\n🎨 Model: {model}\n\n👉 Sign up free — no credit card: {link}\n\n#AIArt #AIImage #NexusAI #GenerativeAI #Creative",
  "🌟 Stunning AI Generation\n\n🏛️ Made with Nexus AI Pro\n💡 Model: {model}\n\n✨ Try now: {link}\n\n#NexusAIPro #AIGenerated #AIArt #Trending #DigitalArt",
  "🪄 AI Magic\n\n🎨 One prompt, endless possibilities\n⚡ Model: {model}\n\n👉 Generate yours free: {link}\n\n#AIArt #NexusAIPro #AIGenerated #CreativeAI #ArtOfTheDay",
];

const CAPTIONS_VIDEO = [
  "🎬 AI-Generated Video\n\n🎥 Powered by Nexus AI Pro\n⚡ Model: {model}\n\n👉 Make your own AI videos: {link}\n\n#AIVideo #AIGenerated #NexusAIPro #DigitalArt",
  "🔥 AI Video Art\n\n🎞️ Made with Nexus AI Pro\n✨ Model: {model}\n\n🚀 Try video generation free: {link}\n\n#AIVideo #NexusAI #AIGenerated #Trending",
  "✨ Stunning AI Video\n\n🎬 Nexus AI Pro — 63+ models\n💫 Model: {model}\n\n🔗 Create videos free: {link}\n\n#AIVideo #AIGenerated #NexusAIPro #CreativeAI #Trending",
];
